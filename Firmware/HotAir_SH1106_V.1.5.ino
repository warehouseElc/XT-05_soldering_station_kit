// Hot air gun controller mod by Warehouse_elc
// Released jan 25, 2021
// Firmware Version 1.5
// Board Version 4.1
// mods : OLED_SH1106 DISP I2C,Remove class PIDscreen for freeing memory
// Origin : https://www.hackster.io/makerbr555/diy-smd-rework-station-28b6f5
...
class DSPL : protected U8X8_SH1106_128X64_NONAME_HW_I2C {
    public:
        DSPL(void) : U8X8_SH1106_128X64_NONAME_HW_I2C () { }
        void    init(void);
...
class HOTGUN : public PID {
    ...
    volatile    uint8_t     cnt;
        ...
        const       uint16_t    min_fan_speed   = 99;
...
SCREEN* mainSCREEN::menu(void) {
  if (mode_temp) {                                                        // Prepare to adjust the fan speed
    ...
    pEnc->reset(fs, min_working_fan, 255, 5, 5);
    mode_temp = false;
